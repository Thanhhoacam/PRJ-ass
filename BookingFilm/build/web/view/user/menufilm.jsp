...
<!--                <ul class="filters_menu">
                    ...
                    <li class="${typeid==null?'active':''}" >  
                        <a href="menu">All</a>
                    </li>
                        <c:forEach items="${requestScope.genres}" var="g">
                        <li class="${typeid==g.genresId?'active':''}">
                            <a  href="menu?genresId=${g.genresId}">${g.name}</a>
                                ...
                                <div class="box" style="box-shadow:  0 0 5px 5px lightgray; ">
                                    <div>
                                        <div class="img-box" style="height: 400px !important; border-radius: 0px !important;">
                                            <img src="view/images/${f.image}" alt="Film Image" style="max-height: none; height: 100%">
                                        </div>
