...
<html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="images/161-1616544_popcorn-icon-cinema-flat-icon-png.png" type="image/png">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-10 col-lg-8">
                                        <div class="detail-b">
                                            <img src="view/images/kungfu.jpg" alt="Image 1">
                                            <div class="caption">
                                                <h3>Kungfu of tear</h3>
                                                <h2>Comming soon</h2>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-7 col-lg-6">
                                        <div class="detail-b">
                                            <img src="view/images/trinh.jpg" alt="Image 2">
                                            <div class="caption">
                                                <h3>Fast & Prison</h3>
                                                <h2>Comming soon</h2>
                                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-7 col-lg-6">
                                        <div class="detail-b">
                                            <img src="view/images/jack.jpg" alt="Image 3">
                                            <div class="caption">
                                                <h3>JACK 97</h3>
                                                <h2>Comming soon</h2>
                                            </div>
