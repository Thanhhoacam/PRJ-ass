...
public class historyBookingController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<HistoryBooking> history = db.getHistoryBooking(id); // lấy lịch sử booking
        request.setAttribute("history", history);
        request.getParameter("ticket.jsp");
        request.getRequestDispatcher("view/user/ticket.jsp").forward(request, response);
    }
