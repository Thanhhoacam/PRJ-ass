...
//        List<Film> films = filmDb.getAllFilm(name);
        String typeid = request.getParameter("genresId");
        List<Film> films = typeid == null ? filmDb.getAllFilm(name) : filmDb.getFilmByCategory(Integer.parseInt(typeid));
