...
//count film status = 1 hay film được công chiếu
...
// search all film co chứa kí tự trong biến name -> search trong user
...
// search film trong thể loại, ngày, đất nước, tên nào đó -> admin
...
// đếm phim trong thể loại,... nào đó -> paging
...
// lấy film theo id -> film comtroller (bấm vào film cụ thể )
...
// cập nhật status film = 0 , đã chiếu rồi
...
//        System.out.println(db.registerFilm(1, "test", "USA", "null", Date.valueOf("2022-01-01"), "ad", "aDA", 100, null, "test"));
        ...
        System.out.println(db.getFilmByCategory(1));
    }
}
